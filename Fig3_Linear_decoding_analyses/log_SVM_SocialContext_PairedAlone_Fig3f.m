%% Log_SVM_SocialContext_PairedAlone_Fig3f
% Run a linear decoder on a the neural activity to decode whether the animal is paired or alone during a given behavior.
