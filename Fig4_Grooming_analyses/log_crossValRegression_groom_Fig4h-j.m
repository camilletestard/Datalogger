%% log_crossValRegression_groom_Fig4h-j
% Run cross-validated regression to predict grooming reciprocity from neural data
% Output will result in Fig 4h-j and Extended Data Fig 4 f,g,i. 
% C. Testard Jan. 2024
