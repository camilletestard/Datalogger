...
backend_args = None
data_root = '/mmpose/fparodi/pseudo-data/macquad/'
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='/mmpose/fparodi/pseudo-data/macquad/val.json',
        backend_args=None,
...
train_dataloader = dict(
    ...
    batch_size=32,
    dataset=dict(
        ann_file='/mmpose/fparodi/pseudo-data/macquad/train.json',
        backend_args=None,
        data_prefix=dict(img='imgs/'),
        data_root='/mmpose/fparodi/pseudo-data/macquad/',
...
work_dir = '/mmpose/fparodi/pseudo-data/macquad/mq_det_yolof'
