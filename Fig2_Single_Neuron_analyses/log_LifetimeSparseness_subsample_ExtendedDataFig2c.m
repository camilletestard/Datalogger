%% Log_LifetimeSparseness_subsample_ExtendedDataFig2c
...
%  with a baseline firing rate (during rest). To account for the effect of
%  amount of data (number of sample points) differing across behaviors,
%  here we sub-sample the number of sample points to be equal across all
%  behaviors. THis script was used to generate Extended Data Fig 2c.
%  Jan 2023, C. Testard
