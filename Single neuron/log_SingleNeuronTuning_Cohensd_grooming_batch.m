...
for s =session_range %1:length(sessions)
    ...
    if with_NC == 0
        ...
        saveas(gcf, [savePath 'Cohend_heatmap_grooming_NoNC_units.png'])
        elseif with_NC == 2
            sgtitle(['Cohens-d heatmap for noise clusters ONLY'])
            saveas(gcf, [savePath 'Cohend_heatmap_grooming_NC_only.png'])
    elseif isolatedOnly
        sgtitle(['Cohens-d heatmap for isolated units'])
        saveas(gcf, [savePath 'Cohend_heatmap_grooming_isolated_units.png'])
    else
        sgtitle(['Cohens-d heatmap for all units'])
        saveas(gcf, [savePath 'Cohend_heatmap_grooming_all_units.png'])
    end
    ...
    saveas(gcf, [savePath '/Prop_units_selective_per_groomContext.png']); close all
...
saveas(gcf, [savePath '/Distribution_effect_size_perGroomContext.png']); pause(2); close all
...
saveas(gcf, [savePath '/Proportion_selective_units_perGroomContext.png']); pause(2); close all
