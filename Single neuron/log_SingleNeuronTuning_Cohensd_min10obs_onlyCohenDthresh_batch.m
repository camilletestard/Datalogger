...
for s =session_range %1:length(sessions)
    ...
    saveas(gcf, [savePath '/Cohend_heatmap_sorted_min10.png']); close all
    figure; set(gcf,'Position',[150 250 1000 500]);
    ...
    saveas(gcf, [savePath '/Cohend_heatmap_sorted_CohenDonly_thresholded_min10.png']); close all
    ...
    saveas(gcf, [savePath '/Distribution_cohend_per_behavior_min10_CohenDonly.png']); %pause(2); close all
    ...
    saveas(gcf, [savePath '/Proportion_units_selective_per_behav_min10_CohenDonly.png']); %pause(2); close all
    ...
    saveas(gcf, [savePath '/Distribution_cohend_all_units_min10_CohenDonly.png']); pause(2); close all
    ...
    saveas(gcf, [savePath '/Distribution_number_selective_behavior_per_unit_min10_CohenDonly.png']); %pause(2); close all
...
saveas(gcf, [savePath '/Distribution_effect_size_per_behavior_min10_CohenDonly.png']); pause(2); close all
...
saveas(gcf, [savePath '/Proportion_selective_units_per_behavior_min10_CohenDonly.png']); pause(2); close all
...
saveas(gcf, [savePath '/Number_selective_behavior_per_unit_min10_CohenDonly.png']); pause(2); close all
