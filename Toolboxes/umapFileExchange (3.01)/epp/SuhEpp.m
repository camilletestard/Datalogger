...
classdef SuhEpp < SuhAbstractClass
                                ...
                                if ~isequal(mns2, mns1)
                                    ...
                                    if ~all(difs<.0001)
                                        if askYesOrNo('Data means differ.. rebuild?')
                                            ...
                                            this.done=false;
                                            warning('Can not continue with data issues');
                                            return;
                                        end
                                    end
                                end
    ...
    methods
        ...
        function [matchedLabelFile, match, matchTable]...
            ...
            function go
                ...
                this.args.match_histogram_fig=viewHistograms;
    ...
    methods(Access=private)
        function initFig(this, hierarchyExplorer)
            ...
            function gatingMl
                if isempty(this.args.gating_ml_file)
                    this.args.gating_ml_file=fullfile(this.folder,...
                        'gatingMl.xml');
                end
                GatingMl.Run(this);
            end
    ...
    methods(Static)
        ...
        function [args, argued, unmatchedArgs, argsObj]=GetArgs(varargin)
            [args, argued, unmatchedArgs, argsObj]=Args.NewKeepUnmatched(...
        ...
        function p=DefineArgs()
            ...
            addParameter(p, 'job_folder', '', @Args.IsFolder);
