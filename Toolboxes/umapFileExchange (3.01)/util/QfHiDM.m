...
%   trainer gets the most blame (false positives)
    ...
    methods
        function relocateFalsePosNegFiles(this, file, saving)
    ...
    methods(Static)
        ...
        function swb=BackgroundReadings(sayBackground, tb, app, newLine)
            if nargin<4
                newLine=false;
                if nargin<3
                    app=BasicMap.Global;
           ...
           '&nbsp;&nbsp;Exhaustive projection' nl 'pursuit (EPP)']}), dflt,...
