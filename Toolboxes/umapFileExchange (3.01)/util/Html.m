...
classdef Html
    ...
    methods(Static)
        ...
        function str=WrapTable(str, cellpadding, pixelWidth)
            if nargin<2
                cellpadding=6;
            end
            if nargin<3
                ...
                app=BasicMap.Global;
                if app.highDef
                    pixelWidth=pixelWidth*app.toolBarFactor;
                end
                str=sprintf(['<html><table width="%dpx" '...
                    'cellpadding="%d"><tr><td>'...
                    '%s</td></tr></html>'], pixelWidth, ...
                    cellpadding, str);
            end
        end
        ...
        function str=FileTree(path, app,forBrowser)
            if nargin<3
                forBrowser=true;
                if nargin<2
                    app=BasicMap.Global;
