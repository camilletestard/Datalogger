...
classdef File
    ...
    methods(Static)
        ...
        function chosenFile=Ask(fileSpec, singleOnly, property, ...
                ttl, dflt, southWestButtons)
            if nargin<6
                southWestButtons=[];
                if nargin<5
                    dflt=[];
            ...
            app=BasicMap.Global;
            choice=Gui.Ask(struct('sortProps', app,'sortProp',property,...
                'msg', Html.WrapHr(['Select a file from<br>&nbsp;'...
                '&nbsp;&nbsp;' app.smallStart allFiles(end).folder ...
                app.smallEnd])), dscs,[], ttl, dflt, ...
