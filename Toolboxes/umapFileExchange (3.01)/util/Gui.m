...
classdef Gui
    ...
    methods (Static)
        ...
        function MsgException(ex, ttl, secs)
            if nargin<3
                secs=8;
                if nargin<2
                    ttl='Argument error...';
            ...
            msgError(Html.WrapHr(['<table width="300px"><tr><tc>'...
                Html.WrapBoldSmall(String.ToHtml( ex.message) ) ...
                '</td></tr></table>']), ...
                secs, 'center', ttl);
...
%                designed position
        ...
        function [fig, tb, personalized]=Figure(removeZoomPan, ...
                property, propertyFile, where1stTime)
            if nargin<1
                removeZoomPan=true;
            end
            fig=figure('toolbar', 'none', 'NumberTitle', 'off', ...
