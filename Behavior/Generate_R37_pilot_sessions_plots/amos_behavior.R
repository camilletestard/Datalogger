...
#Load data:
setwd('C:/Users/Camille Testard/Desktop/Grants_Fellowships/R37_Project/pilot_data/session1')
behavioral_log = read.csv('Behavioral_log.csv')
names(behavioral_log)[1]='eventID'
...
behavs = behavs[-c(1,2,3,5,9,11,15,16)] #behaviors
...
for (b in 1:length(behavs)){
  ...
  data[,c("start.time","stop.time")]=data[,c("start.time","stop.time")]/1000
