...
for channel_flag = ["vlPFC", "TEO", "all"]
    ...
    for partner = [0,1]
        ...
        if partner==1
            ...
            behavior_labels = behavior_labels_subject_init;
        end
        ...
        clearvars -except is_mac savePath mean_hitrate sd_hitrate mean_hitrate_shuffled C_table temp_resolution channel_flag filePath chan temp behavs_eval behav id
    end
    chan = chan +1;
end
%temp = temp+1;
