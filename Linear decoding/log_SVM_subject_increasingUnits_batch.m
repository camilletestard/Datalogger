...
figure;  set(gcf,'Position',[150 250 600 700]); hold on
%subplot(2,1,1);hold on;
cmap = hsv(size(mean_hitrate,1));
for s = session_range_no_partner
    y = mean_hitrate{s};
...
ax = gca;
ax.FontSize = 14;
ylabel('Mean decoding accuracy','FontSize', 16); xlabel('Number of units','FontSize', 16)
%title('Monkey A','FontSize', 14)
